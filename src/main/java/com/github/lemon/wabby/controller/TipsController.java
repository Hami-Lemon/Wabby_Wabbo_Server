...
public class TipsController {
    ...
    public @ResponseBody Resp postTips(@RequestBody TipsEntity tip){
    ...
    public @ResponseBody TipsResp getTips(@RequestParam("type") String type,@RequestParam("page")int page){
    ...
    public @ResponseBody TipsResp getTipsById(@RequestParam("id")int id){
    ...
    public @ResponseBody TipsResp getHotTips(){
